...
const DICT = {
  en: {
    ...
    'nav.story': 'Story',
    'nav.desk': 'Desk',
    'nav.notes': 'Open source',
    'nav.contact': 'Contact',

    'hero.eyebrow': 'Independent studio — London',
    ...
    'hero.cta2': 'Read the studio note',
    'hero.index': 'Current practice',
    'hero.m1.title': 'Interfaces',
    'hero.m2.title': 'Systems',
    'hero.m3.title': 'Experiments',
    ...
    'work.c3.status': 'Private build; case notes available',
    'work.c3.t1': 'Electron',
    ...
    'work.c4.status': 'Private build; case notes available',
    ...
    'notes.label': 'Public signal',
    'notes.title': 'Work that can be inspected.',
    'notes.desc': 'Public repositories and research forks, read directly from GitHub. Private work is labelled private.',
    'notes.status': 'GitHub public API',
    'notes.profile': 'View profile',
    ...
    'contact.p1.h': 'What I build',
    'contact.p1.b': 'Interactive products, learning tools, small games, desktop utilities, and prototypes that need both engineering and a point of view.',
    'contact.p2.h': 'How I work',
    'contact.p2.b': 'Start with behaviour, ship a real object early, then refine the details that make it pleasant to return to.',
  ...
  zh: {
    ...
    'notes.label': '公共信号',
    'notes.title': '可以被检视的工作。',
    'notes.desc': '直接读取 GitHub 的公开仓库与研究分支；私有项目则明确标注为私有。',
    'notes.status': 'GitHub 公共 API',
    'notes.profile': '查看主页',
    ...
    'contact.github': 'GitHub',
    'contact.p1.h': '我做什么',
    'contact.p1.b': '交互产品、学习工具、小型游戏、桌面应用，以及同时需要工程能力与鲜明判断的原型。',
    'contact.p2.h': '我如何工作',
    'contact.p2.b': '从行为出发，尽早做出真正可用的对象，再逐步打磨那些让人愿意反复回来使用的细节。',
